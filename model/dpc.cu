...
void dpc(const short* src, short* dst,int width, int height,int pad_w,int pad_h,int thres) {
    ...
    if ((row < height) && (col < width)) {
        ...
        if ((abs(p1 - p0) > thres) && (abs(p2 - p0) > thres) && (abs(p3 - p0) > thres) && (abs(p4 - p0) > thres) && (abs(p5 - p0) > thres) && (abs(p6 - p0) > thres) && (abs(p7 - p0) > thres) && (abs(p8 - p0) > thres))
        {
